...
public class CircularProfileImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public CircularProfileImageView(Context context, AttributeSet attrs )
    {
        super( context, attrs );
    }

    public CircularProfileImageView(Context context, AttributeSet attrs, int defStyle )
    {
